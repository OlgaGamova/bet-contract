ВАЖНО! При каждом деплое адрес контракта меняется. Адрес "вшит" в page.tsx в переменную CONTRACT_ADDRESS, и его нужно менять на новый после деплоя! Однако в проде предполгается постоянный адрес.
